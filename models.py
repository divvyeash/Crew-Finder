...
class User(db.Model, UserMixin):
    ...
    course = db.Column(db.String(100), default="Not specified yet")
    semester = db.Column(db.String(50), default="Not specified yet")
    skills = db.Column(db.String(200), default="None listed yet")
    bio = db.Column(db.Text, default="No bio written yet.")
    avatar_name = db.Column(db.String(50), default="bottts")

    # The exact relationship names Jinja is looking for
